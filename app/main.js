var obstool = require('./util/obs-tool.js');
var mpvtool = require('./util/mpv-tool.js');
var fbtool = require('./util/filebrowse-tool.js');
var kstool = require('./util/keysend-tool.js');
var imgurl = require('./util/imageurl-tool.js');
var spottool = require('./util/spotify-tool.js');
var fs = require('fs');
var ranauth = false;
